...
public class TestDataControllerValidator : ITestDataControllerValidator
{
    public void ValidateInsert(ITestDataView view)
    {
    ...
    public void ValidateUpdate(int id, ITestDataView view)
    {
        var fields = new List<IInvalidField>();
